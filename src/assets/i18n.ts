export const I18n: { [key: string]: any } = {
    en: {
        ...
        submitButton: 'Submit',
        about: 'Welcome to Tower-Draughts where, in addition to the classic Russian and international draughts, for the first time, the opportunity to play tower draughts has been implemented - one of the most interesting variants of the checkers game.',
        about_continue:
            "The rules of tower's draughts coincide in many respects with the rules of the Russians. The most important difference is that the knocked down checker is not removed from the board but is covered with a hitting checker (a tower of checkers) .In the case when a tower is under attack, one return checker is removed from its top and, if it is the only one of its color, the tower changes color and becomes the enemy's tower. In case of turning into a king, only the top man becomes the king. Another important difference from Russian draughts is the lack of restrictions on capture on previously passed fields (Turkish strike). You can find more information about the game on Wikipedia by clicking on the picture above.",
        play: 'Play',
    },
    ru: {
        homeTitle: 'Home',
