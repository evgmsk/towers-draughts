export const I18n: {[key:string]: any} = {
    ...
    ru: {
        ...
        about_continue: 'Правила столбовых шашек во многом совпадают с правилами русских. Самое главное отличие в том, что сбитаяя шашка не снимается с доски а накрывается бъющей шашкой (башней из шашек) В случае, когда под боем оказаывается башня, с ее вершины снимается одна шашка и, если она единственная своего цвета, то башня меняет цвет и становитсья башней противника. В случае превращения в дамку, дамкой становиться только верхняя шашка. Еще одним важным отличием от русских шашек является отсутсвие ограницений на взятие по ранее пройденным полям (турецкий удар). Дополнительную информацию об игре вы можете найти на википедии кликнув по картинке выше.',
        play: "Играть"
    }
}